...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='weights/yolov5l6.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='models/yolov5l.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/0629_hs.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--save-period', type=int, default=15, help='Save checkpoint every x epochs (disabled if < 1)')
