...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=r'C:\Desktop\Py\MaskDetect\mask dataset\yolov2\0708_v2s\test\images', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='weights/epoch202.pt', help='model.pt path(s)')
